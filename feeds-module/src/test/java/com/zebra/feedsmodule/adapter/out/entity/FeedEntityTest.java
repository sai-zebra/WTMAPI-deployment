...
// This class primarily tests the getters, setters, and constructors generated by Lombok to ensure they behave as expected and kill related PITest mutations, especially for
...
class FeedEntityTest {
    ...
    void allArgsConstructor_shouldCreateEntityWithAllValues() {
        // Given
        feedNotes.add(new FeedNoteEntity()); // Adding a dummy note for the list
